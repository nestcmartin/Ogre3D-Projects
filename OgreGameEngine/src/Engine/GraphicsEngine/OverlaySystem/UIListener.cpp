...
bool UIListener::mouseWheelRolled(const MouseWheelEvent& evt)
{
    ImGuiIO& io = ImGui::GetIO();
...
bool UIListener::mouseMoved(const MouseMotionEvent& evt)
{
    ImGuiIO& io = ImGui::GetIO();
    io.MousePos.x = evt.x;
    io.MousePos.y = evt.y;
...
bool UIListener::mousePressed(const MouseButtonEvent& evt)
{
    ImGuiIO& io = ImGui::GetIO();
...
bool UIListener::mouseReleased(const MouseButtonEvent& evt)
{
    ImGuiIO& io = ImGui::GetIO();
    int b = sdl2imgui(evt.button);
...
bool UIListener::keyEvent(const KeyboardEvent& arg)
{
    ImGuiIO& io = ImGui::GetIO();
...
bool UIListener::keyPressed(const KeyboardEvent& evt)
{
    return keyEvent(evt);
}

bool UIListener::keyReleased(const KeyboardEvent& evt)
{
    return keyEvent(evt);
}


bool UIListener::textInput(const TextInputEvent& evt)
{
    ImGuiIO& io = ImGui::GetIO();
