...
bool OverlayInputListener::mouseWheelRolled(const MouseWheelEvent& evt)
{
    ImGuiIO& io = ImGui::GetIO();
...
bool OverlayInputListener::mouseMoved(const MouseMotionEvent& evt)
{
    ImGuiIO& io = ImGui::GetIO();
    io.MousePos.x = evt.x;
    io.MousePos.y = evt.y;
...
bool OverlayInputListener::mousePressed(const MouseButtonEvent& evt)
{
    ImGuiIO& io = ImGui::GetIO();
...
bool OverlayInputListener::mouseReleased(const MouseButtonEvent& evt)
{
    ImGuiIO& io = ImGui::GetIO();
    int b = sdl2imgui(evt.button);
...
bool OverlayInputListener::keyEvent(const KeyboardEvent& arg)
{
    ImGuiIO& io = ImGui::GetIO();
...
bool OverlayInputListener::keyPressed(const KeyboardEvent& evt)
{
    return keyEvent(evt);
}

bool OverlayInputListener::keyReleased(const KeyboardEvent& evt)
{
    return keyEvent(evt);
}


bool OverlayInputListener::textInput(const TextInputEvent& evt)
{
    ImGuiIO& io = ImGui::GetIO();
